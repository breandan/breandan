...
\item Digital electronics are vastly underutilized for most programming workloads. I design algorithms for unlocking the full capabilities of GPU and SIMD architectures by reducing classical programs to low-depth parallel circuits. Drawing from probabilistic programming, randomized complexity and finite model theory, my research implements compiler tools which solve hard optimization problems under real-time constraints.
...
\resumeSubHeadingListStart
\resumeSubItem{Preprint} {(2025) - \href{https://arxiv.org/pdf/2507.11873}{Syntax Repair as Language Intersection}}

...
\item Computer hardware is massively underutilized for traditional programming workloads. A large class of programs can be drastically accelerated by reduction to a low-depth parallel circuit. My research takes inspiration from probabilistic programming, randomized complexity and finite model theory to implement compiler tools that synthesize and prove exact solutions to hard optimization problems under real-time constraints.
...
\resumeSubItem{\href{https://www.cs.mcgill.ca/}{McGill University}}{-- Ph.D. Student in Computer Science (2019--est. 2026), Co-supervisors: Drs. \href{https://www.cs.mcgill.ca/~jguo/}{Jin Guo} and \href{https://www.cs.toronto.edu/~six/}{Xujie Si}}
...
\resumeSubHeadingListStart
\resumeSubItem{Preprint} {(2024) - \href{https://breandan.net/public/tidyparse.pdf}{Syntax Repair as Language Intersection}}

...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item Consider the polynomial kernel $\Delta: (\mathbf{f}, \mathbf{g})\mapsto (\mathbf{f}\cdot\mathbf{g} + r)^q$ where $\mathbf{f, g}: \mathbb{Z}^d$. Prove the kernel trick for some large $d, q \in \mathbb{N}$. What can we say about its computational complexity? Is this kernel a metric? Prove it.

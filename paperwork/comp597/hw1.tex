...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item Prove that 1D discrete convolution, $*: (f, g)[n] \mapsto \sum_{i \in S}f[n-i]g[i]$, over a finite set $S=[-j, j]^{k}$ for some large $j, k: \mathbb{N}$ is translation equivariant. \textbf{Bonus} (10 points): Prove the 2D case for MNIST images.
    \end{enumerate}

...
\begin{document}
    ...
    \begin{enumerate}
        \item A \textit{diophantine equation} is a polynomial equation whose coefficients and solutions are integers. Let $w, x, y, z \in \mathbb{Z}$ and report your solver's largest nontrivial solutions to each of the following diophantine equations: (a) $w = x^3+y^3+z^3$ (b) $w^3 + x^3 = y^3+z^3$ (c) $w^z + x^z = y^z + z$.

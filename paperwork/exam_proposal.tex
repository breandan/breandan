...
\end{adjustbox}
    ...
    "eeba8" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "a8416" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "4500f" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="pow"]
    "a67f9" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="*"]
    "0.5" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="0.5"]
    "f14a3" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="*"]
    "9c49d" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="*"]
    "59c48" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "980bd" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "8f532" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "1a609" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "e58c4" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "23f5b" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "d829b" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "y₀" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="y₀"]
    "2783d" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "8bd47" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="+"]
    "y₂" ["fontname"="Helvetica","fontsize"="20","shape"="Mrecord","label"="y₂"]
...
%    a -> a [label="Σ₀"]
    ...
    A type tensor $C[\![\cdot]\!]$ indexed by a bijection $\mathcal{F} \times \mathcal{T} \times \mathcal{T} → \mathbb{N}^3$, can be thought of as a type-level function mapping a function and a type to a set of types. Given concrete types $T, S: \mathcal{T}$ and a one-hole context $C[\![\cdot]\!]: T → S$, program synthesis in our type system consists of a sequence of tensor contractions computing the congruence closure on $T$ to determine whether there exists a path from $T$ to $S$. While subtyping, parametric polymorphism and higher-kinded types are possible to encode by considering higher-rank tensors, here we devote our attention the first-order, or rank-3 case, where functions map a concrete type to a concrete type. The typing rules are given below.

...
%    a -> a [label="Σ₀"]
    ...
    Given a similarity metric on code, a straightforward application is code search and indexing. Prior work in code search has explore type-directed~\cite{james2020digging} and learning-based~\cite{gu2018deep} and semantic search~\cite{premtoon2020semantic} techniques separately, but few techniques incorporate the benefits of all three approaches.

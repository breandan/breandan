...
\begin{document}
    ...
    But this is not always possible. Suppose we need to compute the derivative of a program with respect to its inputs. The trouble is, relational equality is not a differentiable operator. Consider the Kronecker $\delta$-function: %$\delta_k: \mathbb{N}^2\rightarrow \mathbb{B}$:

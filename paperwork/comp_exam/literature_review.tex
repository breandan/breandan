...
\begin{document}
    ...
    Reason is the source of all human knowledge. In order to understand reason, we need to understand how concepts are related. In this section, we will review some useful definitions of equivalence in various settings.
...
%    http://users.ox.ac.uk/~scro3229/documents/birmingham-talk.pdf
    ...
    A similar notion also appears in natural language. ``You shall know a word by the company it keeps''. If two different words can be exchanged in all contexts, they are called \textit{synonyms}. Based on this definition, we can define a context as a probabilistic description of the surrounding environment.

    $P(w_t = a \mid w_{t-1}, w_{t-2}\ldots, w_{t+1}, w_{t+2}, \ldots)\overset{?}{\approx} P(w_t = b \mid w_{t-1}, w_{t-2}\ldots, w_{t+1}, w_{t+2}, \ldots)$

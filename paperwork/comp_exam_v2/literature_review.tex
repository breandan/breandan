...
The question is, can we extract any useful knowledge from a trained model? Two broad approaches have been proposed: we could either decode a useful representation, such as a finite~\cite{weiss2018extracting} or weighted finite automaton~\cite{weiss2019learning}, or we could train a model to directly synthesize a graph~\cite{johnson2020learning} using a reinforcement learning based approach. Further investigation is required to understand the tradeoffs between these two approaches.

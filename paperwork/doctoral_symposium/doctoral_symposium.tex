...
\begin{itemize}
  ...
  \item Fifth, the framework must be \textbf{flexible} and \textbf{extensible}. As a general-purpose tool for generating syntax repairs in a wide variety of programming languages, end-users should be able to extend the framework with their own custom grammars and type constraints.
\end{itemize}
